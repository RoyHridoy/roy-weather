...
//     URL = `https://api.openweathermap.org/data/2.5/weather?q=${cityName}&appid=2f4bf6422cdc425dc0094e103dbb6b3d&units=Metric`;
//     requestData(URL);
//   });
...
//     URL = `https://api.openweathermap.org/data/2.5/weather?zip=${zipCode},${countryCode}&appid=2f4bf6422cdc425dc0094e103dbb6b3d&units=Metric`;
//     requestData(URL);
//   });
// }
// getWeatherData();
...
async function requestData(
  ...
  try {
    ...
    document.getElementById("weather-data").innerHTML = `${error}`;
  }
}

/**
 * Get Countries list in Select menu for zip code search option
 */
